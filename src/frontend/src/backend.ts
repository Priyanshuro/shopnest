...
import type { Order as _Order, Product as _Product, StripeSessionStatus as _StripeSessionStatus, UserRole as _UserRole, _ImmutableObjectStorageRefillInformation as __ImmutableObjectStorageRefillInformation, _ImmutableObjectStorageRefillResult as __ImmutableObjectStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async createOrder(arg0: Array<CartItem>, arg1: bigint, arg2: string): Promise<Order> {
        if (this.processError) {
            try {
    ...
    async getSellerEarnings(arg0: SellerId): Promise<bigint> {
        if (this.processError) {
            try {
    ...
    async getSellerOrders(arg0: SellerId): Promise<Array<Order>> {
        if (this.processError) {
            try {
    ...
    async getSellerProducts(arg0: SellerId): Promise<Array<Product>> {
        if (this.processError) {
            try {
    ...
    async getSellers(): Promise<Array<Seller>> {
        if (this.processError) {
            try {
    ...
    async getVerifiedSellers(): Promise<Array<Seller>> {
        if (this.processError) {
            try {
                const result = await this.actor.getVerifiedSellers();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async upsertProduct(arg0: Product): Promise<void> {
        if (this.processError) {
            try {
    ...
    async verifySeller(arg0: SellerId): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.verifySeller(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
